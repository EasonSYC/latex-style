...
\[
    \Bernoulli, \Binomial, \NB, \Multinomial, \Poisson, \Normal, \Exponential, \Geometric, \Uniform
\]
...
\[
    \vm{M}, \vmb{\lambda}, \identityM, \zeroM, \vm{M}\transpose, \vm{M}\hermitian, \vm{M}\perppl
\]
...
\]
\[
    \set{x \in \RR}{x = \frac{a}{b}}, \bound{\Conditional{\frac{x}{y}}{A}}
\]
