...
\begin{theorem}[Very Important Theorem]\label{thm}
...
\begin{corollary}[Obvious Corollary]\label{cor}
    A corollary.
\end{corollary}
...
\begin{claim}[Some Claim]\label{cla}
    Some claim.
\end{claim}
...
\begin{proposition}[Some Proposition]\label{pro}
    A proposition.
\end{proposition}
...
Referencing works as well, like \autoref{def}, \autoref{thm}, \autoref{cor}, \autoref{lem}, \autoref{cla} and \autoref{pro}.
